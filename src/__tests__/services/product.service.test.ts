...
describe('ProductService', () => {
  ...
  describe('getAll', () => {
    it('should return all products', async () => {
      // Arrange
      mockRepository.getProducts = jest.fn(() => Promise.resolve(mockProducts));
    ...
    it('should throw an error when repository fails', async () => {
      ...
      mockRepository.getProducts = jest.fn(() => Promise.reject(error));
  ...
  describe('getById', () => {
    it('should return a product by id', async () => {
      ...
      mockRepository.getProduct = jest.fn((_id: string) => Promise.resolve([mockProducts[0]]));
    ...
    it('should return undefined when product is not found', async () => {
      ...
      mockRepository.getProduct = jest.fn((_id: string) => Promise.resolve([]));
    ...
    it('should throw an error when repository fails', async () => {
      ...
      const productId = 'gid://shopify/Product/1';
      const error = new Error('Repository error');
      mockRepository.getProduct = jest.fn((_id: string) => Promise.reject(error));
